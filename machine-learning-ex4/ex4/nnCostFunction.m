...
z3 = Theta2*a2;
hypo= sigmoid(z3);
A = -y_mat(i,:)'.*log(hypo) - (1-y_mat(i,:)').*log(1-hypo);
J = J + sum(A);
delta3 = hypo - y_mat(i,:)';
delta2 = Theta2'*delta3 .* a2 .* (1-a2);
delta2=delta2(2:end);
Delta1_grad=Delta1_grad + delta2*X(i,:);
...
reg_Theta1_grad = lambda*[zeros(size(Theta1,1),1) Theta1(:,2:end)]/m; 
reg_Theta2_grad = lambda*[zeros(size(Theta2,1),1) Theta2(:,2:end)]/m;
